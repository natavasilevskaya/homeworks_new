...
// Программа принимает на вход двумерный массив. Находит элементы, у которых оба индекса чётные, и заменяет эти элементы на их квадраты.
...
// Программа принимает на вход массив и обменивает элементы первой строки и последней строки
